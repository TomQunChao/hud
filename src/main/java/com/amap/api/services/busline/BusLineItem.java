...
public class BusLineItem implements Parcelable {
    ...
    public String toString() {
        return this.b + " " + nl.a(this.j) + "-" + nl.a(this.k);
    }
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        parcel.writeString(nl.a(this.j));
        parcel.writeString(nl.a(this.k));
    ...
    public BusLineItem(Parcel parcel) {
        ...
        this.j = nl.d(parcel.readString());
        this.k = nl.d(parcel.readString());
