...
public class PoiSearch {
    ...
    public PoiSearch(Context context, Query query) {
        try {
            this.a = (IPoiSearch) sk.a(context, nk.a(true), "com.amap.api.services.dynamic.PoiSearchWrapper", oz.class, new Class[]{Context.class, Query.class}, new Object[]{context, query});
        } catch (qx e) {
            e.printStackTrace();
        }
        if (this.a == null) {
            try {
                this.a = new oz(context, query);
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        }
    ...
    public static class SearchBound implements Cloneable {
        ...
        public SearchBound clone() {
            try {
                ...
                nl.a(e2, "PoiSearch", "SearchBoundClone");
            }
