...
public class WTBT {
    ...
    public native String getRouteFeature(int i);

    public native int getRouteFeatureCount();
    ...
    public native int requestRoutePoi(int i, int i2, WPoiPoint[] wPoiPointArr, WPoiPoint[] wPoiPointArr2);
    ...
    public native void setNaviEndPoi(WPoiPoint wPoiPoint);
