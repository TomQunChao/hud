...
public class LruCache<K, V> {
    ...
    public final V remove(@android.support.annotation.NonNull K r6) {
        /*
            ...
            monitor-enter(r5)
            r0 = 0
            java.util.LinkedHashMap<K, V> r1 = r5.map     // Catch:{ all -> 0x0021 }
            java.lang.Object r1 = r1.remove(r6)     // Catch:{ all -> 0x0021 }
            if (r1 == 0) goto L_0x0016
            int r2 = r5.size     // Catch:{ all -> 0x0027 }
            int r3 = r5.safeSizeOf(r6, r1)     // Catch:{ all -> 0x0027 }
            int r2 = r2 - r3
