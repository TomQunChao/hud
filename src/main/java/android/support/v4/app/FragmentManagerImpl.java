...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        synchronized (this) {
            if (this.mBackStackIndices != null) {
                int N6 = this.mBackStackIndices.size();
                if (N6 > 0) {
                    writer.print(prefix);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:131:0x02f4  */
    /* JADX WARNING: Removed duplicated region for block: B:187:0x0424  */
    ...
    public void scheduleCommit() {
        /*
            r4 = this;
            monitor-enter(r4)
            java.util.ArrayList<android.support.v4.app.FragmentManagerImpl$StartEnterTransitionListener> r0 = r4.mPostponedTransactions     // Catch:{ all -> 0x005b }
            r1 = 0
            r2 = 1
        ...
        L_0x0013:
            r0 = 0
        L_0x0015:
            java.util.ArrayList<android.support.v4.app.FragmentManagerImpl$OpGenerator> r3 = r4.mPendingActions     // Catch:{ all -> 0x005b }
        ...
        L_0x0034:
            goto L_0x0056
        L_0x0036:
            android.support.v4.app.FragmentHostCallback r2 = r4.mHost     // Catch:{ all -> 0x005b }
            android.os.Handler r2 = r2.getHandler()     // Catch:{ all -> 0x005b }
            java.lang.Runnable r3 = r4.mExecCommit     // Catch:{ all -> 0x005b }
            r2.removeCallbacks(r3)     // Catch:{ all -> 0x005b }
            android.support.v4.app.FragmentHostCallback r2 = r4.mHost     // Catch:{ all -> 0x005b }
            android.os.Handler r2 = r2.getHandler()     // Catch:{ all -> 0x005b }
            java.lang.Runnable r3 = r4.mExecCommit     // Catch:{ all -> 0x005b }
        ...
        L_0x005b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.app.FragmentManagerImpl.scheduleCommit():void");
    }
